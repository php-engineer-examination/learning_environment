...
| `<<=`        | [ビット代入演算子] 左シフト                                                                                                                   |
| `<=>`        | [比較演算子] 宇宙船演算子                                                                                                                     |
| `<?=`        | [PHPタグ] 開始タグ `<?php echo` の短縮型                                                                                                      |
| `<?php`      | [PHPタグ] 開始タグ                                                                                                                            |
| `<<<" "`     | [文字列 Nowdoc構文]                                                                                                                           |
| `<<<' '`     | [文字列 ヒアドキュメント構文]                                                                                                                 |
| `=`          | [代入演算子] 代入<br>[デフォルト引数値][関数の引数]                                                                                           |
| `=&`         | リファレンス                                                                                                                                  |
...
| `??=`        | [Null合体代入演算子]                                                                                                                          |
| `@`          | [エラー制御演算子]                                                                                                                            |
| `[]`         | [配列]<br>[文字列 変数のパース] 文字列内の任意の文字                                                                                          |
| `\`          | 名前空間<br>[エスケープ]                                                                                                                      |
| `\n`         | [エスケープ][文字列 二重引用符] ラインフィード、LF、`0x0A`、改行（`PHP_EOL`）                                                                 |
| `\r`         | [エスケープ][文字列 二重引用符] キャリッジリターン、CR、`0x0D`                                                                                |
| `\t`         | [エスケープ][文字列 二重引用符] 水平タブ、HT、`0x09`                                                                                          |
| `\v`         | [エスケープ][文字列 二重引用符] 垂直タブ、VT、`0x0B`                                                                                          |
| `\e`         | [エスケープ][文字列 二重引用符] エスケープ、ESC、`0x1B`                                                                                       |
| `\f`         | [エスケープ][文字列 二重引用符] フォームフィード、FF、`0x0C`                                                                                  |
| `\\`         | [エスケープ][文字列 二重引用符] バックスラッシュ                                                                                              |
| `\$`         | [エスケープ][文字列 二重引用符] ドル                                                                                                          |
| `\"`         | [エスケープ][文字列 二重引用符] ダブルクォテーション                                                                                          |
| `\r\n`       | [エスケープ][文字列 二重引用符] Windows 改行コード（`PHP_EOL`）                                                                               |
| `^`          | [ビット演算子] 排他的論理和(XOR)                                                                                                              |
| `^=`         | [ビット代入演算子] 排他的論理和(XOR)                                                                                                          |
| `` ` ``      | [実行演算子]                                                                                                                                  |
| `_`          | [整数] 整数リテラルの桁の間                                                                                                                   |
...
過去のバージョンで使用できたが、非推奨および廃止された記号を別表にまとめます。  
こちらでは古い PHP ソースコードを確認する際に活用してください。  

**この記号表記は、新しく PHP ソースコードを書くときに使用してはいけません。**  
特に非推奨の記号は実際に動作しますが、将来の PHP バージョンでサポートされなくなります。  
つまり、動作するのに PHP バージョンアップを行った途端に動作しなくなる可能性のあるコードを書くことになるためです。

| 記号                                     | 記号の意味                                                      | 推奨する表記          |
| ---------------------------------------- | --------------------------------------------------------------- | --------------------- |
| `${ }`                                   | [文字列 変数のパース] 複雑な (波括弧) 構文                      | `{$ }`                |
| `${$ }`                                  | [文字列 変数のパース] 複雑な (波括弧) 構文                  | `{${$ }}`                |
| `<%`<br>`%>`                             | [PHP 7.0 変更点 タグ] 開始タグ および 終了タグ                  | `<?php`<br>`?>`       |
| `<%= `<br>`%>`                           | [PHP 7.0 変更点 タグ] 開始タグ および 終了タグ                  | `<?php echo `<br>`?>` |
| `<script language="php">`<br>`</script>` | [PHP 7.0 変更点 タグ] 開始タグ および 終了タグ                  | `<?php`<br>`?>`       |
| `{ }`                                    | [配列] 配列の添字<br>[文字列 変数のパース] 文字列内の任意の文字 | `[ ]`                 |
...
[文字列 変数のパース]: <https://www.php.net/manual/ja/language.types.string.php#language.types.string.parsing>
...
[PHP 7.0 変更点 タグ]: <https://www.php.net/manual/ja/migration70.incompatible.php#migration70.incompatible.other.php-tags>